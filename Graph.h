...
class Graph {
    private:
        /** Potentially valuable instance variables that our graph would have 
         *
         *
         */
        unordered_map<string, vector<tuple<string,string,double>>> adjacencyList;
        // unordered_map<string, vector<tuple<string,string,double>>>:: unordered_map<string, vector<tuple<string,string,double>>(string, vector<tuple<string,string,double>>)
...
class tupleComp{
    public:
        bool operator()(tuple<string,string,double>& first, tuple<string,string,double>& second) const;
};
#endif
